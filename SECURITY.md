...
- **CORS**: an explicit origin allowlist (`http://website.khaddict.lab:8080`, `http://www.website.khaddict.lab:8080`, `http://blog.website.khaddict.lab:8080`, `https://www.khaddict.com`, `https://khaddict.com`, `https://blog.khaddict.com`), `GET`/`POST` only, no wildcard.
