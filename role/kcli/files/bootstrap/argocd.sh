...
CA_VOIDNODE_SECRET=$(vault kv get -field="voidnode.chain.pem" "kv/minions/easypki/chain")
...
ARGOCD_PASSWORD=$(vault kv get -field="argocd_dashboard_password" "kv/kubernetes/argocd")
